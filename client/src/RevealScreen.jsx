    ...
    <main className="min-h-screen overflow-hidden bg-gradient-to-br from-rainbow-blue/60 via-curio-background to-rainbow-yellow/50 p-6 text-curio-text md:p-10">
      ...
      <section className="relative mx-auto max-w-3xl">
        ...
        <header className="animate-card-reveal pr-32 text-center sm:pr-40">
          ...
          <h1 className="mt-4 text-5xl font-black leading-tight tracking-[-0.06em] text-rainbow-purple md:text-7xl">
        ...
        <div className="mt-6 space-y-6">
          <RevealCard delay={100} className="border-rainbow-blue bg-rainbow-blue/20">
            <p className="text-sm font-extrabold uppercase tracking-[0.18em] text-rainbow-blue">Curio fact</p>
          ...
          <RevealCard delay={200} className="border-rainbow-yellow bg-rainbow-yellow/25">
            <p className="text-sm font-extrabold uppercase tracking-[0.18em] text-amber-700">Curio joke</p>
            <button
              type="button"
          ...
          <RevealCard delay={300} className="border-rainbow-green bg-rainbow-green/20">
            <p className="text-sm font-extrabold uppercase tracking-[0.18em] text-green-700">Try it at home</p>
            ...
            <button
              ...
              className="mt-6 rounded-3xl bg-gradient-to-r from-rainbow-purple via-rainbow-pink to-rainbow-red px-6 py-4 text-lg font-black text-white shadow-lg shadow-rainbow-pink/30 transition hover:-translate-y-0.5 hover:shadow-xl focus:outline-none focus:ring-4 focus:ring-rainbow-blue/50"
            >
              Let&apos;s do it!
            </button>
          </RevealCard>
